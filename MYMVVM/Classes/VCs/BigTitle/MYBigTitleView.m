...
@interface MYBigTitleView () <UITextFieldDelegate>
...
- (void)setViewModel:(id<MYViewModelProtocol>)viewModel {
    ...
    if ([viewModel isKindOfClass:[MYBigTitleViewModel class]]) {
        MYBigTitleViewModel *model = (MYBigTitleViewModel *)viewModel;
...
- (void)onClickBigTitle {
    if ([self.viewModel isKindOfClass:[MYBigTitleViewModel class]]) {
        MYBigTitleViewModel *viewModel = (MYBigTitleViewModel *)self.viewModel;
